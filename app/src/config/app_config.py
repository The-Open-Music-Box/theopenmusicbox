...
class AppConfig:
    ...
    def _validate_directories(self) -> None:
        ...
        logger.info(f"✓ Config paths: uploads={upload_dir}, db={app_dir / self._values['db_file']}")
    ...
    def log_format(self) -> str:
        """Logging format."""
        return self._values.get('log_format', '%(asctime)s - %(name)s - %(levelname)s - %(message)s')

...
class ConfigFactory:
    ...
    This class creates configuration instances based on the environment type.
    It sets appropriate environment variables before initializing the configuration.
    """

...
from ...monitoring.improved_logger import ImprovedLogger, LogLevel, logging_context

logger = ImprovedLogger(__name__)

class MockLightSensor(LightSensorInterface):
    def __init__(self):
        with logging_context(operation="init", component="mock_light_sensor"):
    ...
    def _start_monitoring(self):
        def monitor():
            with logging_context(operation="monitor", component="mock_light_sensor"):
    ...
    def cleanup(self):
        with logging_context(operation="cleanup", component="mock_light_sensor"):
            try:

...
class MockLightSensor(LightSensorHardware):
    """
    Mock implementation of LightSensorHardware for testing and non-hardware environments.
    Simulates light level readings using random values.
    """
    def __init__(self):

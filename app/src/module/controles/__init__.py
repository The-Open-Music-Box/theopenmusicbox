...
This module provides access to physical controls (buttons and rotary encoders)
for interacting with the audio playback system.

It provides a singleton pattern access to the ControlesManager,
which manages all physical control devices.
"""

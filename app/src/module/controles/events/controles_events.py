...
Defines event types and event objects for the controls system.
These events are emitted by physical control devices and propagated
through the system via RxPy observables.
"""
...
class ControlesEventType(Enum):
    ...
    These represent the different actions that can be triggered by physical controls.
    """

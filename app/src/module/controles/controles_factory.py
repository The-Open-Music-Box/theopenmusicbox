...
Provides a factory for creating the appropriate controls hardware implementation
based on the current environment (Raspberry Pi or development machine).
"""
...
def create_controles_hardware() -> Union[ControlesMock, 'ControlesGPIO']:
    ...
    if force_mock:
        logger.log(LogLevel.INFO, "Using mock controls hardware (forced by environment)")

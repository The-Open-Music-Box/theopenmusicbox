...
This module tests both positive and negative scenarios for the playback
control endpoints, ensuring that all playback operations work correctly
...
def test_playback_control_pause_no_active(
    test_client_with_mock_db, reset_playback_subject
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_stop_no_active(
    test_client_with_mock_db, reset_playback_subject
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_resume_no_active(
    test_client_with_mock_db, reset_playback_subject
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_next_no_active(
    test_client_with_mock_db, reset_playback_subject
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_previous_no_active(
    test_client_with_mock_db, reset_playback_subject
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playlist_start(
    test_client_with_mock_db, mock_playlist_with_tracks, dummy_audio
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_pause_active(
    test_client_with_mock_db, mock_playlist_with_tracks, dummy_audio
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_resume_after_pause(
    test_client_with_mock_db, mock_playlist_with_tracks, dummy_audio
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_stop_active(
    test_client_with_mock_db, mock_playlist_with_tracks, dummy_audio
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_next_track(
    test_client_with_mock_db, mock_playlist_with_tracks, dummy_audio
):
...
@pytest.mark.audio
@pytest.mark.playlist
def test_playback_control_previous_track(
    test_client_with_mock_db, mock_playlist_with_tracks, dummy_audio
):
...
def test_playback_control_invalid_action(test_client_with_mock_db):
    ...
    with test_client_with_mock_db as client:
        response = client.post(
            "/api/playlists/control", json={"action": "invalid_action"}
        )
...
def test_playlist_start_nonexistent_playlist(test_client_with_mock_db):
    ...
    with test_client_with_mock_db as client:
        response = client.post(
            "/api/playlists/00000000-0000-0000-0000-000000000000/start"
        )

...
# Usage: python check_playlist_files.py /absolute/path/to/upload_folder
# /absolute/path/to/playlist.json
...
def main(upload_folder, playlist_json):
    ...
    print(
        f"Checked {len(tracks)} tracks in playlist '{playlist_data['playlist']['title']}'\n"
    )
